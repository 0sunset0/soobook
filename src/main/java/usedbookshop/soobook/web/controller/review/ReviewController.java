...
public class ReviewController {
    ...
    public String addReviewForm(@RequestParam("bookId") Long bookId, HttpServletRequest request, RedirectAttributes redirectAttributes ){
        ...
        for (Order order : orderList) {
            ...
            for (OrderBook orderBook : orderBookList) {
                if (orderBook.getBook().equals(findBook)){
